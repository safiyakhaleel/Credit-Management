        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="index.php"><i class="fas fa-table"></i><span>HOME</span></a><a class="nav-link" href="alltransfers.php"><i class="fas fa-angle-double-right"></i><span>ALL TRANSFERS</span></a><a class="nav-link" href="alltransfers.php"><i class="fas fa-code"></i><span>Github</span></a>
                        <a
