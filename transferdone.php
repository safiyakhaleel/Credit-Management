...
$var4=$_POST["usercredit2"] + $_POST["credit_amount"];
$sql="UPDATE `users` SET `credit`='". $var4 . "'WHERE `id`='".$_POST['userid2']."'" ;
$conn->query($sql);
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">CREDIT TRANSFER&nbsp; COMPLETED</h3>
                    <div class="row mb-3">
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-body">
                                            <form>
                                                <div class="form-group"><a class="btn btn-primary btn-sm" role="button" href="index.php">HOME</a></div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
